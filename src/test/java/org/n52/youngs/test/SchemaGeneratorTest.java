...
public class SchemaGeneratorTest {
    ...
    public void generateSchema() throws IOException {
        YamlMappingConfiguration config = new YamlMappingConfiguration("mappings/testmapping.yml", NamespaceContextImpl.create(), new XPathHelper().newXPathFactory());
...
//                hasJsonPath("mappings.record.dynamic", is(false)));
    ...
    public void generateSchemaDisabledAndDynamic() throws IOException {
        YamlMappingConfiguration config = new YamlMappingConfiguration("mappings/testmapping-creation-disabled-but-dynamic.yml", NamespaceContextImpl.create(), new XPathHelper().newXPathFactory());
